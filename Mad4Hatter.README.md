...
| output_directory         | Name of the directory where all outputs will be written within the workspace bucket. Timestamped subdirectories will get created to separate outputs from the same workflow. Can only contain alphanumeric, dash, and underscore characters. | String        | Yes      | -                             |
...
| resmarkers_info_tsv      | Custom resistance markers info desired                                                                                                 | File          | No       | -                             |
